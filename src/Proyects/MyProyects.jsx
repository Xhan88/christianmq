      ...
      <h1 className="section-three"><span>03. </span>Some Things I’ve Built ────────────</h1> 
        ...
        <div className='img-container2'>
            ...
            <div className='information-works'>
                        ...
                        <p className='content-description'>My professional butcher presentation website, developed with React,<span> HTML, and CSS</span> , offers an engaging visual experience with Animate.css animations and <span> AOS</span>  hover effects. It showcases my expertise in boning, fine cuts, and customer service, highlighting my background in the meat industry with a modern and dynamic design.</p>
