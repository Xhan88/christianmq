...
return (
    ...
    <div ref={ref} className="gretting-container" >
      ...
      <p className="description" data-aos="fade-up">I am a web developer with 4 years of experience creating websites using <span> Elementor, WordPress, GitHub, MUI, and Bootstrap.</span> I have solid knowledge of 
