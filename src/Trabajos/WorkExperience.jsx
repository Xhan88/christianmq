...
const experiences = [
  { id: 1, company: "Carnicería Matamoros- (WordPress) ", url: "https://carniceriamatamoros.codigomartinez.com/", description: "Website Development for Carnicería Matamoros As part of my web development experience, I had the opportunity to design and create a website for Carnicería Matamoros, using WordPress and the Elementor visual builder. The goal of the project was to provide a professional and functional online presence to improve the business's visibility and facilitate customer interaction." },

  { id: 2, company: "Taquería del Abuelo- (WordPress)",url: "https://delabuelotaqueria.codigomartinez.com/", description: "Website Development for Taquería del Abuelo I developed a website for Taquería del Abuelo using WordPress and Elementor, with a responsive design that adapts to mobile devices, tablets, and computers. The site includes a product menu with the Taquería's menu options, an image gallery to showcase the dishes, and a contact form to facilitate customer interaction. I also integrated an interactive map to easily locate the taquería. I added animations to enhance the visual experience and make navigation more dynamic." },
